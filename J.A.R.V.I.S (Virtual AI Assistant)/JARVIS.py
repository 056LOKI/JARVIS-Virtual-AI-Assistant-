...
class MainThread(QThread):
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            #Individual => Eg: send a message to Lokesh
    ...
    def NameIntheContDataBase(self,command):
        ...
        if bo:
            print(f"Contact Match Found in our data base with {name} and the mobile number is {number}")
            self.talk(f"Boss Contact Match Found in our data base with {name} and the mobile number is {number}")
        else:
    ...
    def Fun(self,command):
        ...
        if 'your name' in command:
            ...
            self.talk("your name is Lokesh")
        elif 'university name' in command:
            self.talk("you are studing in P.R Pote Patil College of engineerting and management,amravati") 
    ...
    def brows(self,command):
        ...
        if 'google' in command:
            ...
            os.startfile('C:\Program Files\Google\Chrome\Application\chrome.exe')#path for your edge browser application
        else :
            self.No_result_found()
    ...
    def open_source(self,command):
        ...
        if 'github' in command:
            ...
            webbrowser.open('https://github.com/056LOKI')
